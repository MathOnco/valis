...
#. Added methods to transfer geojson annotations, such as those generated by QuPath, from slide to another (:code:`Slide.warp_geojson_from_to` and :code:`Slide.warp_geojson`). Also provide examples in documentation. Addresses `github issue 13 <https://github.com/MathOnco/valis/issues/13>`_
...
#. Now installable with `poetry <https://python-poetry.org/>`_ using the pyproject.toml file. 
